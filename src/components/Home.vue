<template>
  <div>
    <div v-if="user">
      ...
      <p v-if="overview.length===0" style="text-align: center">空空如也，快去<router-link to="/manage">获取</router-link>属于自己的网站分析吧。</p>
    </div>
    <div v-else>
      ...
      <h3 class="introduce"><router-link to="/login" style="color: darkred; font-weight: 600">开始吧</router-link></h3>
    </div>
    ...
    <ol>
      ...
      <li>
        ...
        <p>代码安装完毕后，可以通过点击刷新按钮重新检测代码安装状态，本功能通过抓取网站页面，分析是否安装了正确的统计代码，所以若您的网站打开速度较慢，或者限制程序抓取网页，会导致系统无法判断，但不影响网站正常分析。</p>
